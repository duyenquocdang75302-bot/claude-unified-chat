...
export function Sidebar({
  ...
  const sharedProject = projects.find((project) => project.id === SHARED_PROJECT_ID);
          ...
          {projects.map((project) => (
            <div
              ...
              className={`group relative mb-2 ${
                project.id === SHARED_PROJECT_ID ? "rounded-2xl border-2 border-accent/40 bg-accent/5 p-1" : ""
              }`}
            >
              <button
